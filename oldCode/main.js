...
import Navigation from './pages/elements/navigationv2/navigation.js'
            ...
            TweenLite.to(this, 0.5, {
                ...
                onComplete: () => {
                    ...
                    if(this.state.viewIndex !== this.state.prevViewIndex) {
                        ...
                        this.refs['nav'].animate(this.state.viewIndex)
