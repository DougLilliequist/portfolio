...
export default class ViewLoader extends Component {
    ...
    componentDidMount() {
        ...
        this.scrollMax = ReactDOM.findDOMNode(this.currentView).getBoundingClientRect().height * this.projectCount
    ...
    render() {
        ...
        return(
            ...
            <div className = "Loader" ref = {(container) => this.container = container}>
                ...
                <Project ref = {(view) => {this.currentView = view}} project = 'letsGetPhysical' />
